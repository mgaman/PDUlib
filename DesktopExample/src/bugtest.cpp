...
void issue41(PDU mypdu) {
    const char *pdu = "";
    if (mypdu.decodePDU(pdu)) {
        std::cout << mypdu.getSCAnumber() << std::endl;
        std::cout << mypdu.getSender() << std::endl;
        std::cout << mypdu.getTimeStamp() << std::endl;
     ...
     std::cout << "Decode issue41 failed\n";
